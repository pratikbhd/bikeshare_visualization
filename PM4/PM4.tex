...
For this milestone, we have expanded on our progress from the third milestone. One of the major tasks was to work on the development of the time histogram which encoded the number of bike rents for a particular period of time. Along with learning the tools and techniques required for developing the visualization, we have refined our work in this process as well.
...
\input{visualization}
%%\input{task_and_data_abstraction}

%%\input{preliminary_designs}

%%\input{technical_progress}
